...
import controller.ControllerUsu_Compromisso;
...
public class CompromissoView extends javax.swing.JFrame {
     ...
     * @param id
     */
    public CompromissoView(Usuario u, Long id) {
		usuarioLogado = u;
        initComponents();
        this.setId(id);
    ...
    private void onClickBtnConfirmarCompromisso(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_onClickBtnConfirmarCompromisso
        if (txtTitulo.getText().equals("")) {
            ...
            try {
                ...
                Long idtmp = cc.cadastrar(this.getId(), txtTitulo.getText(), txtDescricao.getText(), txtImportancia.getSelectedIndex(), cInicio, cFim, usuarioLogado.getId());
                this.setId(idtmp);
                ControllerUsu_Compromisso cuc = new ControllerUsu_Compromisso();
                cuc.deletar(this.getId());
                for (int i = 0; i < jTable1.getRowCount(); i++) {
                    if ((boolean) jTable1.getModel().getValueAt(i, 0)) {
                        Long l = (Long) jTable1.getModel().getValueAt(i, 1);
                        cuc.cadastrar(l, this.getId());
                    }
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CompromissoView(null, 0l).setVisible(true);
            }
        });
    }
    ...
    private void addUsuarios() {
        try {
            ...
            ArrayList<Usuario> usuarios = controllerUsuario.listar();
            DefaultTableModel defaultTableModel = (DefaultTableModel) jTable1.getModel();
            ControllerUsu_Compromisso cuc = new ControllerUsu_Compromisso();
            for (Usuario u : usuarios) {
                boolean incluido = cuc.usuarioEmCompromisso(u.getId(), this.getId());
                defaultTableModel.addRow(new Object[]{incluido, u.getId(), u.getNome()});
            }
